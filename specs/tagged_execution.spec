...
* Create a scenario "first scenario" in specification "tags_execution" with the following steps
...
* Create a scenario "second scenario" in specification "tags_execution" with the following steps
     |step text           |implementation               |
     |--------------------|-----------------------------|
...
* Create a scenario "third scenario" in specification "tags_execution" with the following steps
     |step text           |implementation               |
     |--------------------|-----------------------------|
